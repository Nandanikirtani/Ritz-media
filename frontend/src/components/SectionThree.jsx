...
const SectionThree = () => {
  return (
    <section className="w-full bg-[#1E1B4B] p-4  sm:py-16">
      <div className="max-w-6xl mx-auto flex flex-col-reverse md:flex-row items-center gap-10 px-2 sm:px-4">
        ...
        <div className="md:w-1/2 text-white">
          ...
          <h3 className="text-lg sm:text-xl font-medium mb-3 text-yellow-400">
            Explore:
          </h3>
        ...
        <div className="md:w-1/2 flex justify-center md:justify-end">
          <img
            src={mask}
            alt="Team Meeting"
            className="w-full max-w-md md:max-w-lg h-auto rounded-lg shadow-lg object-cover"
          />
        </div>
      </div>
    </section>
